...
def _write_round_summary(
    ...
    *,
    ...
    target_object_id = _parse_reason_object_id(reason_result, "target_id")
    ...
    summary = {
        ...
        "selected_object_is_final_target": selected_object_id == target_object_id,
        "branch": reason_result.get("branch"),
        "selected_part_id": _parse_reason_object_id(
            reason_result,
...
def _run_pipeline_round(
    ...
    *,
    ...
    try:
        ...
        _log(f"ERROR: {exc}")
        sys.exit(1)
    selected_final_target = selected_object_id == target_object_id
    _log(
