...
def _belief_after_miss(
    ...
    if not new_mids:
        return {}
    # Do not issue a counterfactual VLM request for every possible removal.
    # The miss-side belief is geometry-only: equivalent visible area and
    # visible-mask depth determine the normalized probabilities of the newly
    # exposed top-layer candidates.
    return compute_geometric_prior(
        new_mids,
