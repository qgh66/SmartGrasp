#!/usr/bin/env bash
# Reveal push simulation with local JAKA ZU3 + Robotiq visualization.
# Run from anywhere.
...
OUTPUT="${OUTPUT:-results/reveal_push_jaka.json}"
PORT="${PORT:-8051}"

echo "=========================================="
echo " Reveal Push Simulation - JAKA ZU3 Visual"
echo " ROOT:     $ROOT"
