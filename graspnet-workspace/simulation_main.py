...
def parse_args():
    ...
    parser.add_argument('--testing_case', action='store', type=str, default='case04-fruit.txt')
...
if __name__ == "__main__":
    ...
    if os.path.exists(args.testing_case_dir):
        ...
        print("DEBUG filelist sample:", filelist[:50])
        ...
        for episode in range(num_episode):
            ...
            while not done:
                ...
                messages = [
                    {
                        ...
                        "content": (
                            ...
                            "***If the target object is not visible, detect the most possible area that can hide the target object. Meanwhile you should also tell the reason why you choose this area*** Then select the most cost-effective object or object part considering ease of grasping, importance, and safety.\n"
                            ...
                            "Reason for selecting the area that may hide the target object: [your reason]\n"
                            ...
                            "Reason for selecting the area that may hide the target object: The blue ball is partially occluded by the yellow bottle, so I selected the area around it to ensure a clear view for grasping.\n"
                            "Objects and Their Properties:\n"
                            "Object: Blue Ball\n"
                            "Grasping Score: 90\n"
                ...
                try:
                    ...
                    # Output API response
                    print(f"Response from LLM:{output}")
                    logging.info(output)
